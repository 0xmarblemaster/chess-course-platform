-- COMPLETE Database Schema for Chess Course Platform
-- This handles existing tables and creates missing ones properly
...
-- Step 14: Drop existing functions to avoid conflicts
...
-- Step 16: Create function to promote user to admin
...
-- Step 17: Create trigger for new user signup
