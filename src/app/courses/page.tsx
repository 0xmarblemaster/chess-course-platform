                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                    ...
                    <div className="flex-shrink-0 w-full sm:w-auto">
                      <Link
                        ...
                        className="block w-full sm:w-auto text-center bg-indigo-600 text-white px-4 sm:px-6 py-2 rounded-lg text-sm font-medium hover:bg-indigo-700 transition-colors"
                      >
